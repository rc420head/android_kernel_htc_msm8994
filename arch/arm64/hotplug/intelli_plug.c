...
static unsigned int nr_run_thresholds_balance[] = {
	...
	(THREAD_CAPACITY * 1600 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 2400 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 3800 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 5800 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 8000 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 10400 * MULT_FACTOR) / DIV_FACTOR,
	UINT_MAX
};
